                                           ...
                                           @if (!in_array($role['id'] == 1, $roles))
                                            ...
                                            <div class="col-lg-6 pt-5">
                                                <div class="custom-control custom-radio entity-box">
                                                    ...
                                                    <input type="radio" id="freelancer" name="freelancer" value="freelancer" class="custom-control-input">
                                                    ...
                                                    <input type="radio" id="employer" name="employer" value="employer" class="custom-control-input">
                                                    </label>
                                                    @elseif($role['role_type'] === 'intern')
                                                    <label class="custom-control-label" for="intern">

                                                    <input type="radio" id="intern" name="intern" value="intern" class="custom-control-input">
