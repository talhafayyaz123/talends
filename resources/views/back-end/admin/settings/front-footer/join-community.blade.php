    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 float-left" id="services">
            ...
            <div class="wt-haslayout wt-post-job-wrap">
                ...
                @if(!isset($join_community) && empty($join_community))

                {!! Form::open([
                'url' => url('admin/join_community'),
                ...
                <div class="wt-dashboardbox">
                 ...
                 @else
                 {!! Form::open(['url' => url('admin/update-join-community/'.$join_community['id'].''),
                'enctype'=>'multipart/form-data',
                    ...
                    <div class="wt-dashboardboxcontent">
                        <div class="wt-jobdescription wt-tabsinfo">
                            ...
                            <div class="wt-formtheme wt-userform wt-userformvtwo">
                                <fieldset>
                                    <div class="form-group">
                                        {!! Form::textarea('banner_description', e($join_community['banner_description']), ['class' => 'wt-tinymceeditor', 'id' => 'wt-tinymceeditor', 'placeholder' => trans('lang.job_dtl_note')]) !!}
                                ...
                                <div class="wt-attachmentsholder">
                                    <div class="lara-attachment-files">
                                        <div class="wt-tabscontenttitle">
                                            ...
                                            @php $image = '/uploads/home-pages/footer/'.$join_community['about_talends_image']; @endphp
