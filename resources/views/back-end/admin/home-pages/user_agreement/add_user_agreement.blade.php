...
<div class="wrap-search wt-haslayout">
    ...
    <div class="form-group">
        <div class="form-group-holder">
            {!! Form::text('user_agreement['.$no.'][title]', null, ['class' => 'form-control',
        ...
        <div class="wt-jobskills wt-tabsinfo">
            ...
            {!! Form::textarea('user_agreement['.$no.'][description][]', null, ['class' => 'wt-tinymceeditor', 'id' => 'wt-tinymceeditor', 'placeholder' => trans('lang.job_dtl_note')]) !!}
        </div>
