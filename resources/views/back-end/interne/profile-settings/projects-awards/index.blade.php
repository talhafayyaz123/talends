                    ...
                    <div class="wt-dashboardbox wt-dashboardtabsholder">
                        ...
                        <div class="wt-tabscontent tab-content">
                            ...
                            <div class="wt-awardsholder" id="wt-awards">
                                {!! Form::open(['url' => url('freelancer/store-project-award-settings'), 'class' =>'wt-formtheme wt-userform wt-formprojectinfo', 'id' => 'awards_projects', '@submit.prevent' => 'submitInterneAwardsProjects']) !!}
                                    <div class="wt-addprojectsholder wt-tabsinfo">
                                        @if (file_exists(resource_path('views/extend/back-end/freelancer/profile-settings/projects-awards/projects.blade.php'))) 
                                            @include('extend.back-end.interne.profile-settings.projects-awards.projects')
                                        @else 
                                            @include('back-end.interne.profile-settings.projects-awards.projects')
                                        @endif
                                    </div>
                                    <div class="wt-addprojectsholder wt-tabsinfo la-awards">
                                        @if (file_exists(resource_path('views/extend/back-end/freelancer/profile-settings/projects-awards/awards.blade.php'))) 
                                            @include('extend.back-end.interne.profile-settings.projects-awards.awards') 
                                        @else 
                                            @include('back-end.interne.profile-settings.projects-awards.awards') 
                                        @endif
                                    </div>
