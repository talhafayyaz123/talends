                    ...
                    <div class="wt-dashboardbox wt-dashboardtabsholder">
                        ...
                        <div class="wt-tabscontent tab-content">
                            <div class="wt-educationholder" id="wt-education">
                                {!! Form::open(['url' => url('freelancer/store-experience-settings'), 'class' =>'wt-formtheme wt-userform', 'id' => 'experience_form', '@submit.prevent'=>'submitInterneExperienceEduction']) !!}
                                    <div class="wt-userexperience wt-tabsinfo">
                                        @if (file_exists(resource_path('views/extend/back-end/freelancer/profile-settings/experience-education/experience.blade.php'))) 
                                            @include('extend.back-end.interne.profile-settings.experience-education.experience')
                                        @else 
                                            @include('back-end.interne.profile-settings.experience-education.experience')
                                        @endif
                                    </div>
                                    <div class="wt-userexperience wt-tabsinfo">
                                        @if (file_exists(resource_path('views/extend/back-end/freelancer/profile-settings/experience-education/education.blade.php'))) 
                                            @include('extend.back-end.interne.profile-settings.experience-education.education')
                                        @else 
                                            @include('back-end.interne.profile-settings.experience-education.education')
                                        @endif
                                    </div>
