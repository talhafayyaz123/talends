        ...
        <div class="row">
                ...
                <div class="bg-dark text-white p-3">
                    <div class="media align-items-center pl-md-5">
                        ...
                        <div class="media-body ml-3">
                            ...
                            <h4 class="text-white">Contact Your Customers with Quick & Best possible response to Gurantee your Project!</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 border-right pr-0">
                <div class="border-bottom mb-4 p-4">
                    <h6 class="text-white mb-0">786 leads matching with your lead preferences</h6>
                    <h6 class="text-white">Updated Just Now</h6>
                </div>
                <div class="border-bottom p-4 mb-4">
                    <h6 class="text-white">Majid Al Futtaim</h6>
                    <h6 class="text-white">Mobile Application Development Additional Details/ Applications - business/ Required: Changes to that App that can do ecommerce</h6>
                    <h6 class="text-white">Dubai <i class="bi-geo-alt-fill"></i></h6>
                </div>
                <div class="border-bottom p-4 mb-4">
                    <h6 class="text-white">Emaar</h6>
                    <h6 class="text-white">Mobile Application Development Additional Details/ Applications - business/ Required: Changes to that App that can do ecommerce</h6>
                    <h6 class="text-white">Dubai <i class="bi-geo-alt-fill"></i></h6>
                </div>
                <div class="border-bottom p-4 mb-4">
                    <h6 class="text-white">Damac</h6>
                    <h6 class="text-white">Mobile Application Development Additional Details/ Applications - business/ Required: Changes to that App that can do ecommerce</h6>
                    <h6 class="text-white">Dubai <i class="bi-geo-alt-fill"></i></h6>
                </div>
            </div>
            <div class="col-md-8">
                ...
                <div class="px-4 mb-5">
                    <div class="row">
                        <div class="col-md-12">
                            <h6 class="text-white">Project Details</h6>
                            <h6 class="text-white mb-4">We would like to develope an app We would like to develope an app We would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an app We would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an app We would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an appWe would like to develope an app</h6>
