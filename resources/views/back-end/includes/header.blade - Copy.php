                                ...
                                <div class="wt-rightarea">
                                    ...
                                    @auth
                                        @php
                                            ...
                                            $profile_image = !empty($user_image) ? '/uploads/users/'.$user->id.'/'.$user_image : config('app.aws_se_path'). '/' .'images/user-login.png';
                                        ...
                                        <div class="wt-userlogedin">
                                            <figure class="wt-userimg">
                                                {{-- <img src="{{{ ($profile_image) }}}" alt="{{{ trans('lang.user_avatar') }}}"> --}}
