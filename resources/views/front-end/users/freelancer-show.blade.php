        ...
        <div class="row justify-content-md-center" style="margin-bottom: 200px;">
            <div class="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-6 push-lg-3">
                ...
                <div class="wt-innerbannercontent">
                    <div class="wt-title">
                        <h2>{{ Helper::getUserName($user->id) }}</h2>
                    </div>
                            ...
                            <div class="wt-widgetcontent">
                                <ul class="wt-socialiconssimple">
                                    ...
                                    <li class="wt-pinterest">
                                        <a href="//pinterest.com/pin/create/button/?url={{ urlencode(Request::fullUrl()) }}" onclick="window.open(this.href, \'post-share\',\'left=50,top=50,width=600,height=350,toolbar=0\'); return false;">
    ...
    <section class="suggested-freelancer">
        <div class="container-fluid px-md-5">
            <div class="row">
                ...
                @foreach ($similar_users as $key => $freelancer)
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="{{ $feature_class }} border-bottom">
    ...
    <section class="faq-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7">
                  {!!$freelancer_side_bar->features_text ?? ''!!}
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="content-box">
                        ...
                        {!!$freelancer_side_bar->project_description ?? ''!!}
                    </div>
                </div>
            </div>
        </div>
