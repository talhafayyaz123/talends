...
@section('content')
        ...
        <div class="container">
            <div class="row row-eq-height">
                <div class="col-md-7 pb-3 align-self-center">
                    ...
                    <h2 class="text-white">Find an Intern <br><span class="theme_color"> You'll love</span></h2>
    ...
    <section class="">
        ...
        <form class="form-inline" method="GET">
            <div class="row row-eq-height">
                <div class="col-md-12">
                    <div class="talent_filters intern_filters">
                ...
                <div class="col-md-6">
                    <div class="talent_list_box">
                        <div class="tlb__img">
                            ...
                            <img src="{{{ asset('talends/assets/img/find-talents/banner.png') }}}" alt="{{ trans('lang.img') }}">
                        </div>
                        <div class="tlb__content">
                            ...
                            <div class="tlb__reviews row">
                                ...
                                <div class="tlb__reviews_score intern_reviews">
                                    <ul>
                                        <li>5.0/5.0</li>
                                        <li>12 Reviews</li>
                                    </ul>
                ...
                <div class="col-md-6">
                    <div class="talent_list_box">
                        <div class="tlb__img">
                            ...
                            <img src="{{{ asset('talends/assets/img/find-talents/user2.png') }}}" alt="{{ trans('lang.img') }}">
                        </div>
                        <div class="tlb__content">
                            <div class="row" >
                ...
                <div class="col-md-6">
                    <div class="talent_list_box">
                        <div class="tlb__img">
                            ...
                            <img src="{{{ asset('talends/assets/img/find-talents/user3.png') }}}" alt="{{ trans('lang.img') }}">
                        </div>
                        <div class="tlb__content">
                            <div class="row" >
                ...
                <div class="col-md-6">
                    <div class="talent_list_box">
                        <div class="tlb__img">
                            ...
                            <img src="{{{ asset('talends/assets/img/find-talents/user4.png') }}}" alt="{{ trans('lang.img') }}">
                        </div>
                        <div class="tlb__content">
                            <div class="row" >
