...
@section('content')
                ...
                <div class="col-md-12">
                    <div class="talent_filters">
                        ...
                        <select name="gender" class="talent_select" id="gender">
                          ...
                          <option value="female">Islamabad</option>
                      </select>
                        <select name="" class="talent_select" id="">
                          <option value="">Expertise</option>
                          <option value="Video Editors">Developer</option>
                          <option value="Data Analyst">Data Analyst</option>
                      </select>
                        <select name="" class="talent_select" id="">
                          <option value="">Pricing</option>
                          <option value="Video Editors">5-100$</option>
                          <option value="Data Analyst">100-1500$</option>
                      </select>
                        <select name="" class="talent_select" id="">
                          <option value="">Toatl Team</option>
                          <option value="Video Editors">5-30</option>
                          <option value="Data Analyst">30-100</option>
                      </select>
                    </div>
                </div>
            </div>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="talent_list_box company_box">
                        <div class="tlb__img"><img src=" {{ asset('talends/assets/img/company/netsol.png') }}" alt=""></div>
                        <div class="tlb__content">
                            <h3>CES Web Development</h3>
                ...
                <div class="col-md-6">
                    <div class="talent_list_box company_box">
                        <div class="tlb__img"><img src=" {{ asset('talends/assets/img/company/techlogix.png') }}" alt=""></div>
                        <div class="tlb__content">
                ...
                <div class="col-md-6">
                    <div class="talent_list_box company_box">
                        <div class="tlb__img"><img src=" {{ asset('talends/assets/img/company/bop.png') }}" alt=""></div>
                        <div class="tlb__content">
                            <h3>cKAri Designs</h3>
                            <p>User Interface Designer</p>
                            <div class="tlb__reviews">
                ...
                <div class="col-md-6">
                    <div class="talent_list_box company_box">
                        <div class="tlb__img"><img src=" {{ asset('talends/assets/img/company/systems.jpg') }}" alt=""></div>
                        <div class="tlb__content">
                ...
                <div class="col-md-6">
                    <div class="talent_list_box company_box">
                        <div class="tlb__img"><img src=" {{ asset('talends/assets/img/company/askari.png') }}" alt=""></div>
                        <div class="tlb__content">
                            <h3>Web Hosting</h3>
                            <p>User Interface Designer</p>
                            <div class="tlb__reviews">
