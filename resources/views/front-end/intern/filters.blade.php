<aside id="wt-sidebar" class="wt-sidebar wt-usersidebar freelancer_filters pb-3 border-bottom internee_filters_setting">
        ...
        <div class="d-md-flex w-100 px-md-0 px-3 mb-3 flex-row">
                            ...
                            @endphp
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="custom-control custom-check freelancer_category">
                                        <input class="custom-control-input" id="category-{{{ $key }}}" type="checkbox"  name="category[]" value="{{{$category->id}}}" {{$checked }} >
            ...
            <!-- <div class="wt-widget wt-effectiveholder">
                ...
                <div class="wt-widgetcontent freelancer_sub_cat_filter" style="display: none;">
                    <fieldset>
                        <div class="wt-checkboxholder wt-verticalscrollbar sub_categories">Sub Categories</div>
                    </fieldset>
                </div>
            </div> -->
