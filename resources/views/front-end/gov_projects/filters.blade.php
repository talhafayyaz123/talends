<aside id="wt-sidebar" class="wt-sidebar freelancer_filters">
    {!! Form::open(['url' => url('search-results'), 'method' => 'get', 'class' => 'wt-formtheme wt-formsearch','style'=>'border-bottom: 1px solid #ddd4d4']) !!}
    ...
    <div class="d-md-flex w-100 px-md-0 px-3 my-4">
        <div class="dropdown position-static filter-dropdown">
            ...
            <div class="dropdown-menu checkbox-menu allow-focus w-50 top-auto p-2" aria-labelledby="dropdownMenu1">
                <div class="row">
                    <div class="col-md-11 mx-auto">
                        <fieldset>
                            ...
                            <a-slider id="wt-pricerange" class="wt-productrangeslider wt-themerangeslider" range :min="0" :max="max_value" :reverse="reverse" @change="onChange" :default-value="[start, end]" ref="priceRange" v-if="show_price_slider" />
                        </fieldset>
