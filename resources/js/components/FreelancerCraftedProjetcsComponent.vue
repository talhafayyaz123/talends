    ...
    <div class="wt-projects">
        <div class="wt-project" v-if="index <= projects.length" v-for="(commentIndex, index) in commentsToShow" :key="index">
            <figure  v-if="projects[index]">
                <img :src="Aws_S3_PATH+'/uploads/users/'+freelancer_id+'/projects/'+projects[index].project_hidden_image" :alt="projects[index].project_hidden_image" v-if="projects[index].project_hidden_image">
                <img :src="Aws_S3_PATH+'/images/projects/img-01.jpg'" :alt="img" v-else>
            </figure>
