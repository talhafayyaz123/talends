 ...
 */
 ...
 jQuery(document).ready(function () {
     ...
     tinymce.init({
         ...
         height: 300,
         theme: 'modern',
         plugins: ['code advlist autolink lists link image charmap print preview hr anchor pagebreak','lists'],
         menubar: true,
         statusbar: true,
         toolbar1: 'undo redo | insert | image | styleselect | bold italic | alignleft aligncenter alignright alignjustify code | numlist bullist',
         image_advtab: true,
         inline_styles : true,
